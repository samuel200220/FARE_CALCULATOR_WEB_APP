  ...
  const toggleLang = () => {
    ...
    return (
        <header className='sticky top-0 z-[100] h-20 flex items-center justify-between px-0 lg:px-4 md:px-4 sm:px-4 py-4 bg-white w-full dark:bg-[#0D1B2A]'>
            ...
            <Link href={'#'} scroll={true} className='font-bold text-blue-800 dark:text-white items-center text-xl lg:text-3xl sm:text-3xl md:text-3xl ml-0'>Fare Calculator</Link>
            </nav>
            ...
            {/* <Link href={"/statistiques"} className='hidden lg:flex text-white  font-medium mr-4 text-[18px] hover:text-violet-800 dark:text-white dark:hover:text-violet-600'>
                ...
                <Link href={"/aide1"} className='hidden lg:flex text-blue-800 text-sm font-medium text-[18px] hover:text-violet-800 dark:text-white dark:hover:text-violet-600'>
                    Aide
                </Link>
