  ...
  return (
    <header className="sticky top-0 z-[100] h-20 flex items-center justify-between px-0 lg:px-4 md:px-4 sm:px-4 py-4 bg-blue-700 w-full dark:bg-[#0D1B2A]">
      ...
      <div className="flex items-center gap-4 dark:flex dark:items-center dark:gap-4">
        <Link
          href="/statistiques"
          className="hidden lg:flex text-white font-medium mr-4 text-[18px] hover:text-violet-300"
        >
          {t("dashboard")}
        </Link>
        ...
        <Link
          href="/aide1"
          className="hidden lg:flex text-white text-sm font-medium text-[18px] hover:text-violet-300"
        >
          {t("help")}
        </Link>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button className="bg-transparent border-none shadow-none text-white hover:text-violet-300 hover:bg-transparent">
        ...
        <Link href="/connexionpro">
          <Button className="cursor-pointer mr-2 bg-transparent dark:bg-[#0D1B2A] hover:text-violet-300 hover:bg-transparent dark:hover:bg-[#0D1B2A] lg:text-[18px] md:text-[18px] sm:text-[18px] text-[16px] text-white">
            {t("logout")}
          </Button>
        </Link>
