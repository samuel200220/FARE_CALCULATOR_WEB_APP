...
export default function TestimonialsPro() {
  ...
  return (
    <section className="py-24 px-4 relative overflow-hidden bg-white dark:bg-slate-950 transition-colors duration-500">
      ...
      <motion.h2
        ...
        className="text-4xl md:text-5xl font-black text-center mb-20 text-slate-900 dark:text-white tracking-tight"
      >
        {t('title')}
      </motion.h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto relative z-10">
        {testimonials.map((testi, i) => (
          <motion.div
            ...
            "
          >
            <FaQuoteLeft className="absolute top-10 right-10 text-4xl text-primary/10 dark:text-primary/10" />

            <div className="flex items-center gap-5 mb-8">
              <div className={`w-16 h-16 rounded-2xl ${testi.color} flex items-center justify-center text-white text-2xl font-black shadow-lg shadow-primary/20`}>
                {testi.initial}
              </div>
              <div>
                ...
                <p className="text-primary dark:text-blue-400 font-bold tracking-wide text-sm uppercase">
                  {testi.title}
                </p>
              </div>
            </div>

            <div className="flex gap-1.5 text-amber-500 mb-6 text-sm">
