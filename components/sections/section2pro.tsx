...
const services = [
  ...
  description:
    'Planifiez et réservez vos voyages nationaux ou internationaux facilement avec notre agence.',
  link: '#',
  },
  {
...
const Section2Pro = () => {
  return (
    <section
      id="services"
      className="bg-white dark:bg-[#0D1B2A] pt-10 pb-20 px-4 sm:px-6 lg:px-8"
    >
