...
const Section4 = () => {
  ...
  return (
    <section id="propos" className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors duration-500">
      {/* Decorative Blob */}
            ...
            <Link href={{ pathname: info.link }} className="block group h-full">
              ...
              ">
                <div className="flex flex-col items-center h-full text-center">
                  <div className="p-5 bg-primary/5 dark:bg-primary/10 rounded-full mb-8 group-hover:rotate-12 group-hover:bg-primary/10 transition-all duration-500">
                    {info.icon}
                  </div>
                  <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">
                    {info.title}
                  </h3>
                  <div className="w-16 h-1 bg-gradient-to-r from-primary to-blue-400 rounded-full mb-8 opacity-30 group-hover:opacity-100 transition-all duration-500" />
