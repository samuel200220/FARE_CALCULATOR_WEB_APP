...
const Section4 = () => {
  return (
    <section id='propos' className='mt-40 mb-0 justify-center h-[630px] bg-white dark:bg-[#0D1B2A] pt-14 items-center flex flex-col'>
        <h2 className='text-4xl text-center mb-8 text-blue-700 font-bold dark:text-white'>A Propos De Nous</h2>
