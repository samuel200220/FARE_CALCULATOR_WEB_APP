  ...
  return (
    <section id='propos' className='mt-40 mb-0 justify-center items-center flex flex-col'>
        ...
        <div className='flex justify-center items-center gap-6'>
            <div className='w-72 h-80 flex-none m-6 bg-white dark:bg-[#0D1B2A] p-4 rounded-4xl border overflow-hidden relative shadow-lg
            ...
            <div className='w-72 h-80 flex-none m-2 bg-white dark:bg-[#0D1B2A] p-4 rounded-4xl border overflow-hidden relative shadow-lg
                    transform transition-transform duration-300 ease-in-out
                    hover:scale-105 hover:shadow-2xl hover:cursor-pointer'>
            ...
            <div className='w-73 h-80 flex-none m-6 bg-white dark:bg-[#0D1B2A] p-4 rounded-4xl border overflow-hidden relative shadow-lg
                    transform transition-transform duration-300 ease-in-out
                    hover:scale-105 hover:shadow-2xl hover:cursor-pointer'>
