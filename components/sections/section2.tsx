...
const Section2 = () => {
  return (
    <section id='services' className='bg-white dark:bg-[#0D1B2A] h-[700px] pt-32 justify-center mt-40 mb-0 dark:from-blue-800 dark:to-blue-700'>
        <h2 className='text-4xl text-center mb-8 text-blue-700 font-bold dark:text-white dark:decoration-white'>Nos Services</h2>
        <div className='flex justify-center items-center gap-10'>
            <Link href={'#'}>
            <div className='w-72 h-80 flex-none m-6 bg-gray-100 p-4 rounded-4xl dark:bg-gray-800 dark:text-white border overflow-hidden relative shadow-lg
                    transform transition-transform duration-300 ease-in-out
                    hover:scale-105 hover:shadow-2xl hover:cursor-pointer'>
                <h3 className='text-center mb-5 text-2xl'><span className="text-blue-700">Reserver</span> Un Taxi Pour Une Course</h3>
            ...
            <Link href={'#'}>
            <div className='w-72 h-80 flex-none m-2 bg-gray-100 p-4 rounded-4xl dark:bg-gray-800 dark:text-white border overflow-hidden relative shadow-lg
                    transform transition-transform duration-300 ease-in-out
                    hover:scale-105 hover:shadow-2xl hover:cursor-pointer'>
                <h3 className='text-center mb-5 text-2xl'><span className="text-blue-700">Reserver</span> Une Place Dans Un Taxi</h3>
            ...
            <Link href={'#'}>
            <div className='w-73 h-80 flex-none m-6 bg-gray-100 p-4 rounded-4xl dark:bg-gray-800 dark:text-white border overflow-hidden relative shadow-lg
                    transform transition-transform duration-300 ease-in-out
                    hover:scale-105 hover:shadow-2xl hover:cursor-pointer'>
                <h3 className='text-center mb-5 text-2xl'><span className="text-blue-700">Reserver</span> Chauffeur Pour Le Depot</h3>
