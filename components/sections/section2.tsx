...
const Section2 = () => {
  return (
    ...
    //     </div>
    // </section>
    <section id='services' className='bg-white dark:bg-[#0D1B2A] lg:pt-32 lg:rounded-none lg:ml-0 lg:mr-0 lg:pb-32 sm:pt-10 sm:pb-8 sm:rounded-3xl sm:ml-4 sm:mr-4 mt-40 mb-0 px-4'>
  <h2 className='text-3xl sm:text-4xl lg:text-5xl text-center lg:mb-8 sm:mb-10 md:mb-10 text-blue-700 font-bold dark:text-white'>Nos Services</h2>

  <div className='flex flex-col lg:flex-row justify-center items-center gap-10 w-full max-w-6xl mx-auto'>
    <Link href={'#'}>
      <div className='w-full lg:max-w-xs lg:h-80 sm:flex sm:flex-col md:flex md:flex-col bg-gray-100 p-4 sm:rounded-xl md:rounded-xl lg:rounded-4xl dark:bg-gray-800 dark:text-white border shadow-lg transform transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl hover:cursor-pointer'>
